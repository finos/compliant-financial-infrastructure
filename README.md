...
- <img src="docs/_images/diamond.png" alt="diamond" width="60" height="25"/> - Post-deployment validation tests exist for every aspect of the SAA,
and all tests pass in the CI pipeline testing phase.
- <img src="docs/_images/gold.png" alt="gold" width="37" height="30"/> - Post-deployment validation tests are run in CI as part of the testing phase,
and some tests pass.
...
- <img src="docs/_images/bronze.png"  alt="bronze" width="50" height="22"/> - IaC has been produced that is able to create and destroy the service,
where said service meets the SAA specification.
- <img src="docs/_images/paper.png" alt="paper" width="45" height="17"/> - A complete SAA document for this service has been merged to `main`.
